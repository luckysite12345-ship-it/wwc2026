...
const superadminAgentsRoutes = require('./routes/superadmin-agents');
const superadminPlayers = require('./routes/superadminPlayers');
...
app.use('/api/superadmin', superadminAgentsRoutes);
app.use('/api', superadminPlayers);
// ==========================
// AUTH MIDDLEWARE
// ==========================
